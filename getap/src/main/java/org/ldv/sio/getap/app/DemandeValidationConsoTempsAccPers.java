...
*/
	...
	public void modifieeParEleve() throws DVCTAPException {
		if (!this.isValideeProf() && !this.isRefuseeProf()
			...
			Date dateLog = new Date();
			logger.info("\n MODIFICATION PAR ELEVE : " + dateLog + "\n "
					+ this.toString());
	...
	public void modifieeDateParLeProfesseur() throws DVCTAPException {
		if (!this.isValideeProf() && !this.isRefuseeProf()
			...
			Date dateLog = new Date();
			logger.info("\n MODIFICATION DATE PAR PROF : " + dateLog + "\n "
					+ this.toString());
	...
	public void modifieeDureeParLeProfesseur() throws DVCTAPException {
		if (!this.isValideeProf() && !this.isRefuseeProf()
			...
			Date dateLog = new Date();
			logger.info("\n MODIFICATION DUREE PAR PROF : " + dateLog + "\n "
					+ this.toString());
	...
	public void modifieeAPParLeProfesseur() throws DVCTAPException {
		if (!this.isValideeProf() && !this.isRefuseeProf()
			...
			Date dateLog = new Date();
			logger.info("\n MODIFICATION AP PAR PROF : " + dateLog + "\n "
					+ this.toString());
	...
	public String toString() {
		return "DemandeValidationConsoTempsAccPers [id=" + id
				...
				+ dateAction + ", minutes=" + minutes + ",\r Professeur =\t"
				+ prof + ",\r AccPers =\t" + accPers + ",\r Eleve =\t" + eleve
				+ ", etat=" + etat + "]";
	}
